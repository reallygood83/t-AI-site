        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-8">
            <a 
              ...
              className="inline-flex items-center gap-2 bg-indigo-600 text-white px-8 py-4 rounded-xl font-bold hover:bg-indigo-700 transition-all duration-300 shadow-lg hover:shadow-xl text-lg group"
            >
              <span className="text-white">발급 사이트 바로가기</span>
